...
public class Sc_OptionsMenu : MonoBehaviour
{
    ...
    public void ShowOptionsMenu()
    {
        ...
        LeanTween.scale(myOptionsTransform, new Vector3(1.0f, 1.0f, 1.0f), 0.50f).setEase(LeanTweenType.easeInExpo);
    }
    public void HideOptionsMenu()
    {
        LeanTween.alphaCanvas(myOptionsCanvasGroup, 0.0f, 0.50f).setEase(LeanTweenType.easeOutExpo);
        LeanTween.scale(myOptionsTransform, new Vector3(0.0f, 0.0f, 0.0f), 0.50f).setEase(LeanTweenType.easeOutExpo);
